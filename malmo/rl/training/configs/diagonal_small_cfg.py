"""
training/configs/diagonal_small_cfg.py
--------------------------------------
1-block gap with 1-block X offset. Tests diagonal sprint-jumping.
"""
...
class DiagonalSmallCFG(BaseCFG):
    MISSION_FILE = os.path.join(
        BaseCFG.ROOT_DIR, "envs", "diagonal_small", "missions", "diagonal_small.xml"
    )
    MALMO_PORT       = 10000
    SPAWN            = (0.5, 46.0, 3.5)
    GOAL_POS         = (1.5, 45.0, 5.5)
