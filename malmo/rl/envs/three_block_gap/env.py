"""
envs/three_block_gap/env.py
-------------------------------------
Malmo environment wrapper for the three-block gap task.
Identical to simple_jump/env.py — only the config differs.
"""
...
class ParkourEnv:
    ...
    def _get_reward(self, obs, prev_z):
        ...
        if z >= self.cfg.Z_SUCCESS and obs.get("OnGround", False):
